...
export default React.createClass({
  ...
  handleSignIn() {
    ...
    ddpClient.loginWithUsername(username, password, (err, res) => {
    ...
    this.refs.username.setNativeProps({
      text: ''
    });
    this.refs.password.setNativeProps({
      text: ''
    });
  },
  ...
  handleSignUp() {
    ...
    ddpClient.signUpWithUsername(username, password, (err, res) => {
      ddpClient.onAuthResponse(err, res);
      if (res) {
        this.props.changedSignedIn(true);
      } else {
